  ...
  return (
    <>
      ...
      <div className='flex items-center justify-center ml-55'>
        <div className='w-0 h-0 border-t-[100px] border-b-[100px] border-r-[240px] sm:border-t-[130px] sm:border-b-[130px] sm:border-r-[400px] md:border-t-[130px] md:border-b-[130px] md:border-r-[400px] border-t-transparent border-b-transparent border-r-orange-300'>
        </div>
      </div>
